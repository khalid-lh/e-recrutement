...
Route::put('/recruteur/profil/updatelogo',[\App\Http\Controllers\RecruteurController::class,'update_logo']);
...
Route::get('/recruteur/mescondidaturs/downloadcv/{cv}',[\App\Http\Controllers\PostulerController::class,'downloadCV']);
