...
const routes = [
    ...
    { path: '/candidat/dashboard', name: 'condidature_dashboard' , component: dashboard_condidature},
    { path: '/candidat/profil', name: 'profil_condidature' , component: profilCondidature},
    { path: '/candidat/mesenregistrement ', name: 'mesenregistrement' , component: mesEnregistrement},
